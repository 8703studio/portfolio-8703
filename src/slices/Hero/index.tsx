      ...
      <div className="hero-section">
        <div className="sticky ">
         ...
         <div className="relative place-self-center w-full"> 
            <div className=" bg-brand-orange whitespace-nowrap overflow-hidden text-ellipsis max-w-full"><Heading size="custom"><PrismicText field={slice.primary.heading} /></Heading>
            </div>
            </div>
